...
public class WarrantyService {
    ...
    public ResponseEntity<String> createWarranty(Warranty warranty, MultipartFile multipart) throws StripeException {
        ...
        metadata.put("productName", warranty.getProductName()); // Add productName
        metadata.put("modelNumber", warranty.getModelNumber()); // Add modelNumber
        ...
        // Save the Stripe productId and warrantyId in the ProductRepository
        ProductEntity productEntity = new ProductEntity();
        productEntity.setProductId(product.getId());
        productEntity.setWarrantyId(warranty.getWarrantyId());

        // Assuming you have a ProductRepository to save ProductEntity
